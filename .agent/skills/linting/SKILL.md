...
2.  **What it Does**:
    ...
    -   Then, it runs `cargo clippy --all-targets --all --all-features -- -D warnings` to analyze the code for lints, dead code, and unused imports, and please fix suggested errors.
    -   Finally, it runs `cargo shear` to analyze the code for lints, dead code, and unused imports, and please fix suggested errors.

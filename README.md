...
*   **Attention Enhancements**: 
    *   Fully integrated **Rotary Positional Embeddings (RoPE)** computed deterministically inside `kernel/rope.cu` via raw PTX memory sequences natively bypassing global Sequence Embeddings (`wpe`).
